...
from data.create_database.database import Income
from dsa.extract.income.income_momo import GetMomoIncome
from dsa.extract.income.income_bank import GetBankIncome
...
if __name__ == "__main__":
    SaveIncomeMomo().save_income()
    SaveIncomeBank().save_income()
